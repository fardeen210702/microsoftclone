  ...
  return (
    <div className='micro3 w-full shadow-lg shadow-black mt-3 p-2 '>
        <div className="details">
            <details ><summary className='list-none flex items-center justify-between sticky top-0 bg-white py-3 border-b-2 border-blue-950 font-bold'>How it works <FaAngleRight/> </summary>
            ...
            {/* second Detail */}
            <details ><summary className='list-none flex items-center justify-between sticky top-0 bg-white py-3 border-b-2 border-blue-950 font-bold'> Featured news<FaAngleRight/> </summary>
            <div className="detail my-4 ">
                ...
                <div className="containers w-full my-4 border shadow-sm shadow-black rounded-2xl p-2">
                    <img src={feature2} alt=""  className='w-full h-[120px] object-cover rounded-2xl '/>
                    ...
                    <button className='w-full bg-gray-900 text-white py-3 rounded-2xl '>Learn more</button>


                </div>
                {/* second feature */}
                <div className="containers w-full my-4 border shadow-sm shadow-black rounded-2xl p-2">
                    <img src={feature1} alt=""  className='w-full h-[120px] object-cover rounded-2xl '/>
                    ...
                    <button className='w-full bg-gray-900 text-white py-3 rounded-2xl '>Read the blog </button>


                </div>
                {/* thirdfeature */}
                <div className="containers w-full my-4 border shadow-sm shadow-black rounded-2xl p-2">
                    <img src={feature3} alt=""  className='w-full h-[120px] object-cover rounded-2xl '/>
                ...
                {/* fourth feature */}
                <div className="containers w-full my-4 border shadow-sm shadow-black rounded-2xl p-2">
                    <img src={feature4} alt=""  className='w-full h-[120px] object-cover rounded-2xl '/>
