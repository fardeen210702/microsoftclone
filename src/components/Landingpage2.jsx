...
function Landingpage2() {
    return (
        <div className=' sm:flex sm:flex-wrap'>
            <div className="img1 sm:w-1/2">
                <div className="details p-4 ">
                <img src={img1} className = 'w-full' alt="" />

                    <h1 className='text-2xl font-bold my-3 '>Surface Laptop 5 </h1>
            ...
            <div className="img1 sm:w-1/2">
                ...
                <img src={img2} className = 'w-full' alt="" />
                    ...
                    <h1 className='text-2xl font-bold my-3 '>Surface Laptop Studio</h1>
            ...
            <div className="img1 sm:w-1/2">
                ...
                <div className="details p-4 ">
                    ...
                    <h1 className='text-2xl font-bold my-3 '>Xbox Series X</h1>
