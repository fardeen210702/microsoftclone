...
function Teams2() {
  return (
    <div className='flex flex-col p-2 mt-6 space-y-9 sm:mt-16'>
        ...
        <div className='flex flex-col space-y-10 sm:space-y-0 gap-6 sm:flex-row sm:flex-wrap'>
            <div className="detail1 h-[250px]  sm:w-1/2 w-full sm:max-w-[300px] border shadow">
